...
""" % bcb_dev)
  ...
  is_plus = target_info.GetBuildProp("org.pixelexperiencex.version").endswith(
        "_plus")
  android_version = target_info.GetBuildProp("ro.build.version.release")
  build_id = target_info.GetBuildProp("ro.build.id")
  build_date = target_info.GetBuildProp("org.pixelexperiencex.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("org.pixelexperiencex.device")
  script.PrintPixelExperienceXBanner(android_version, build_id, build_date,
